...
const Footer = () => {
  ...
  if (dateRendezVous == 0) {
    alert(
      "Nous ne sommes pas ouvert le dimanche, veuillez saisir une autre date"
    );
  }
  ...
  return (
    <footer>
      <section class="contact">
        <div class="contact-list">
          <div class="list_image">
            <div id="contact-img">
              <img src={logo} height="128px" alt="logo garage parrot" onClick={goAccueil}/>
            </div>
          </div>
          <div class="list">
            <h5>LIENS RAPIDES</h5>
            <ul class="infos-p">
              <li>
                <a onClick={goAccueil}>Accueil</a>
              </li>
              <li>
                <a onClick={goOccasions}>Nos occasions</a>
              </li>
              <li>
                <a onClick={goContact}>Contact</a>
              </li>
              <li>
                <a onClick={goConnexion}>Connexion</a>
              </li>
            </ul>
          </div>
          <div class="list">
            <h5>HORAIRES</h5>
            <div className="horaire_footer">
            ...
            <div className="bouton_footer">
              <button className="buttonRendezVous" onClick={openModal}>
              ...
              >
                <form onSubmit={priseRdv} className="priseRdv">
                  <div>
                    ...
                    {dateRendezVous === 0 ? null : dateRendezVous !== 6 ? (
                      <div className="choixCreneau">
                        <label htmlFor="creneau" id="creneau">
                        ...
                        <input
                          ...
                          id="creneau"
                          name="creneau"
                          onChange={(e) => setCreneau("Après-midi")}
                          required
                        ></input>
                        Après-midi
                      </div>
                    ...
                    {dateRendezVous === 6 || creneau === "Matin" ? (
                      ...
                      >
                        <option value="">
                          Veuillez choisir votre heure de rendez-vous
                        </option>
              ...
              <button
                className="boutonContactDetailVoitureTelephone"
                onClick={openModal2}
              >
                Téléphone
              </button>
      ...
      <h5 className="copyright">
        Copyright © 2024 Garage parrot All Rights Reserved.
      </h5>
    </footer>
  );
};
